  ...
  return (
    <div className="space-y-4 text-left w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch w-full">
        ...
        <Card className="lg:col-span-7 p-5 sm:p-6 flex flex-col justify-between space-y-4">
          {/* Header Row: Title & Status Pill */}
          <CardHeader className="p-0 flex items-center justify-between pb-1 border-b border-slate-100">
          ...
          <CardFooter className="p-0">
            <div className="p-3 sm:p-3.5 rounded-xl bg-[#F0FDF4] border border-[#BBF7D0] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs w-full">
